...
\begin{center}
{\huge
\textbf{Implementación de MCTS y Redes Convolucionales para el desarrollo de una red neuronal en R}
}
...
[1] Awati, R. (27 de octubre del 2025). \textit{What is a neural network?}. 
\url{https://www.techtarget.com/searchenterpriseai/definition/neural-network}

[2] Klein, D. (2022). \textit{Neural networks for chess: The magic of deep and reinforcement learning revealed}. 
arXiv. \url{https://arxiv.org/abs/2209.01506}

[3] Aggarwal, C. C. (2018). \textit{Neural networks and deep learning: A textbook}. Springer.

[4] Bishop, C. M. (2006). \textit{Pattern recognition and machine learning}. Springer Science+Business Media.

[5] Goodfellow, I., Bengio, Y., \& Courville, A. (2016). \textit{Deep learning}. MIT Press.

[6] Silver, D., Hubert, T., Schrittwieser, J., Antonoglou, I., Lai, M., Guez, A., Lanctot, M., Sifre, L., 
Kumaran, D., Graepel, T., Lillicrap, T., Simonyan, K., \& Hassabis, D. (2018). 
A general reinforcement learning algorithm that masters chess, shogi, and Go through self-play. 
\textit{Science}, 362(6419), 1140–1144. \url{https://doi.org/10.1126/science.aar6404}

[7] Alam, S. (2023). An investigation of the imputation techniques for missing data. \textit{ScienceDirect}. 
Recuperado de \url{https://www.sciencedirect.com/science/article/pii/S2772662223001819}

[8] DeLeo, M., \& Guven, E. (s.f.). \textit{Learning chess with language models and transformers}. 
Whiting School of Engineering, Johns Hopkins University.

[9] R Core Team. (s.f.). \textit{CRAN: Manuals – The Comprehensive R Archive Network}. 
Recuperado de \url{https://cran.r-project.org/manuals.html}

[10] Chang, M., \& Liang, T. (2018). \textit{Recreating AlphaZero Chess Engine}. 
Reporte de proyecto del curso CS230: Deep Learning, Stanford University.

[11] Pomares C., M. (s.f.). \textit{Entropy and Economics}. Preprint. 
Recuperado de \url{https://arxiv.org/abs/2407.00022}
